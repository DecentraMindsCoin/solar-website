...
function OurTeam() {
  return (
    <div className="border-b border-2 shadow-xl">
        ...
        >
          ...
          <div className="item-center grid mx-8">
            ...
            <div className="text-center">
              ...
              <p className="text-md text-gray-500 dark:text-gray-400 max-w-full py-4 lg:px-16 font-light">
          ...
          <div className="grid item-center mx-8">
            ...
            <div className="text-center">
              <p className="text-2xl text-gray-800 dark:text-white">James White</p>
              <p className="text-xl text-gray-500 dark:text-gray-200 font-light">
                Sales Manager
              </p>
              <p className="text-md text-gray-500 dark:text-gray-400 max-w-full lg:px-16 py-4 font-light">
