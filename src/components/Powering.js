  ...
  return (
    <div className="w-full relative sm:h-screen shadow-xl bg-black px-4 p-6">
      <div className="max-w-3xl mx-auto">
        <h2 className="hover:scale-120 transition transform ease-in duration-200 tracking-widest font-barriecito text-center mt-16 mb-10 md:mt-12 text-4xl text-white font-extrabold text-gray-100 sm:text-4xl lg:text-6xl">
          {" "}
          <span className="tracking-widest font-barriecito text-yellow-500 cursor-pointer animate-pulse">
            Powering
          </span>{" "}
          New Mexico.
      ...
      <p className='text-yellow-500 text-sm font-light py-3'>-<span className='italic text-gray-400'>"Satisfying our awesome customers comes first, by offering the best prices in New Mexico on the highest quality Solar!" 
        ...
        <p className="mx-1 text-base lg:text-xl md:text-lg font-extralight sm:mt-10 text-white py-12">
          ...
          Gaurantee!  It only
          takes a few minutes to get a free quote. Meraki offers the highest grade Solar Panels in New Mexico! We will make sure your investment into Solar pays off with immediate savings!
        </p></div>
