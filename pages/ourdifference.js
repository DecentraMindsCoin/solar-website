...
function ourdifference() {
    return (
      ...
      {/* Header */}
      <div className="relative md:pb-32 bg-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">Our Difference</h1>
      ...
      {/* Overlapping cards */}
      <section
        className="-mt-32 max-w-7xl mx-auto relative z-10 pb-32 px-4 sm:px-6 hidden lg:px-8"
